...
1. Choose the region and compartment
   ...
   Review the terms and restrictions, and then click on the checkbox to accept them.  Then, click on **Launch Stack**,
    ...
    > **Note:** This Live Lab is tested with **version 0.2.1**.  Later versions should work, but earlier versions do not contain all features used in this Live Lab.
